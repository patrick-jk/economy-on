...
class FutureChartFragment : Fragment() {
    ...
    private fun setupChart() {
        ...
        personalDevDataSet)
        val types = arrayOf(
            requireContext().getString(R.string.first_month),
            requireContext().getString(R.string.second_month),
            requireContext().getString(R.string.third_month),
            requireContext().getString(R.string.forth_month),
            requireContext().getString(R.string.fifth_month),
            requireContext().getString(R.string.sixth_month))
